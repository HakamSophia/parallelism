...
void parse_args(int argc, char **argv) {
  ...
  desc.add_options()
    ...
    ("g_size_x,x", po::value<int>()->default_value(256), "Size of the first dimension of the domain")
    ("g_size_y,y", po::value<int>()->default_value(256), "Size of the second dimension of the domain")
